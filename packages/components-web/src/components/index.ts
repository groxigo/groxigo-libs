// Components-web barrel — rebuilt from Figma composites
...
export { RecipeListGrid } from './RecipeListGrid';
export type { RecipeListGridProps } from './RecipeListGrid';

export { CategoryListGrid } from './CategoryListGrid';
export type { CategoryListGridProps } from './CategoryListGrid';

// Recipe
export { RecipeTagChip } from './RecipeTagChip';
...
export type { DeliverySlotPickerProps } from './DeliverySlotPicker';
...
export type { NotificationsCardProps } from './NotificationsCard';

export { PreferencesCard } from './PreferencesCard';
export type { PreferencesCardProps } from './PreferencesCard';

// Account & Auth
export { AccountMenuItem } from './AccountMenuItem';
export type { AccountMenuItemProps } from './AccountMenuItem';
...
export { DietaryPreferenceChip } from './DietaryPreferenceChip';

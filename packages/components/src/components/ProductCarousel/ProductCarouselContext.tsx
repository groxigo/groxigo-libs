 ...
 * swipe left/right navigation between products on the product detail page.
 *
 * @example
 * ```tsx
 * // In your root layout
 * import { ProductCarouselProvider } from '@groxigo/components';
 *
...
export function ProductCarouselProvider({ children }: { children: ReactNode }) {
  ...
  return (
    <ProductCarouselContext.Provider value={{ products, currentIndex, setCarouselData, clearCarouselData }}>
      {children}

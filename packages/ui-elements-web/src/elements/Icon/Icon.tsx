...
const iconPaths: Record<string, React.ReactNode> = {
  ...
  'tag-fill': (
    <path
      fillRule="evenodd"
      d="M5.25 2.25a3 3 0 00-3 3v4.318a3 3 0 00.879 2.121l9.58 9.581c.92.92 2.39 1.186 3.548.428a19.596 19.596 0 005.656-5.656c.758-1.158.492-2.629-.428-3.548l-9.58-9.581a3 3 0 00-2.122-.879H5.25zM6.375 7.5a1.125 1.125 0 100-2.25 1.125 1.125 0 000 2.25z"
      clipRule="evenodd"
    />
  ),
  ...
  leaf: (
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M12 21c4.418 0 8-4.03 8-9s-3.582-9-8-9c-4.418 0-8 4.03-8 9 0 2.69 1.08 5.122 2.813 6.835M12 21l-3.187-3.165M12 21v-9m0 9c-.714 0-1.406-.086-2.063-.248M8.813 17.835A7.973 7.973 0 0112 12"
    />
  ),
  nutrition: (
    <path
